...
Plotly.d3.csv('votos_por_predio.csv', function(err, rows){
    ...
    data.mode = "markers";
    data.subplot = "mapbox";
    data.marker = {symbol: 'circle', opacity: 1, sizemin: 10, sizemode: 'area', size: unpack(rows, 'validos'), color : unpack(rows, 'per_edivaldo'), colorscale: 'Bluered', sizeref: 15, sizemin:6};
